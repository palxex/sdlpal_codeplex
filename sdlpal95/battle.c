...
--*/
{
   ...
   SDL_SetPalette(g_Battle.lpBackground, SDL_LOGPAL | SDL_PHYSPAL, VIDEO_GetPalette(), 0, 256);
...
--*/
{
   ...
   SDL_SetPalette(g_Battle.lpSceneBuf, SDL_LOGPAL | SDL_PHYSPAL, VIDEO_GetPalette(), 0, 256);
